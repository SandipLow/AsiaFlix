...
router.post(
    ...
    async (req, res) => {
        try {
            ...
            const videoUrl = `${process.env.API_URL}/uploads/${vidId}/index.m3u8`;
            const thumbnailUrl = `${process.env.API_URL}/uploads/${vidId}/thumbnail.jpg`;
